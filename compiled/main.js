...
"use strict";
/* harmony default export */ __webpack_exports__["a"] = (function (context, text, x, y, lineWidth, color) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__func_data_form_js__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__func_helpers_loading_js__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__func_helpers_init_canvas_js__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_downloadjs__ = __webpack_require__(16);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__func_images_gamersgate_js__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__func_images_made_in_lithuania_js__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__func_draw_strokeText_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__func_draw_outlineText_js__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__func_draw_drawTransparentBackground_js__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__func_helpers_readImageFromField_js__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__func_draw_setImageSmoothingEnabled_js__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__func_behaviors_move_js__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__func_behaviors_zoom_js__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__func_draw_drawGradientBar_js__ = __webpack_require__(42);
...
var form = Object(__WEBPACK_IMPORTED_MODULE_1__func_data_form_js__["a" /* default */])('tool', {
    banner_type: __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#banner_type'),
    game_name: __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#game_name'),
    game_platform: __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#game_platform'),
    banner: __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#banner'),
    game_flag: __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#game_flag'),
    game_image_size: __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#game_image_size')
}),
    context = form.banner.get(0).getContext("2d"),
    image = {
    box: null,
    background: null,
    gamersgate: __WEBPACK_IMPORTED_MODULE_5__func_images_gamersgate_js__["a" /* default */],
    made_in_lithuania: __WEBPACK_IMPORTED_MODULE_6__func_images_made_in_lithuania_js__["a" /* default */]
},
    ...
    if (platform != 'PC') caption += ' (' + platform + ')';
    return caption;
};

Object(__WEBPACK_IMPORTED_MODULE_11__func_draw_setImageSmoothingEnabled_js__["a" /* default */])(context, true);

var redraw = function redraw(options) {
    if (!options) {
        options = {};
    }
    ...
    if (!options.noTransparent) {
        Object(__WEBPACK_IMPORTED_MODULE_9__func_draw_drawTransparentBackground_js__["a" /* default */])(context, 625, 190, 7);
    }

    if (image.background) context.drawImage(image.background, form.banner.data('x'), form.banner.data('y'), image.background.width * form.banner.data('zoom') / 100, image.background.height * form.banner.data('zoom') / 100);

    if (image[form.game_flag.val()]) {
        context.drawImage(image[form.game_flag.val()], 0, 0);
    }

    Object(__WEBPACK_IMPORTED_MODULE_14__func_draw_drawGradientBar_js__["a" /* default */])(context, 0, 190 - 32, 625, 190 - (32 - 12), "#D9DAD5", "#D7D9D4");
    Object(__WEBPACK_IMPORTED_MODULE_14__func_draw_drawGradientBar_js__["a" /* default */])(context, 0, 190 - (32 - 12), 625, 190, "#D7D9D4", "#B1B6B0");
    ...
    Object(__WEBPACK_IMPORTED_MODULE_8__func_draw_outlineText_js__["a" /* default */])(context, caption, textX, textY, 5, 255, 255, 255);
    ...
    if (image.box) {
        ...
        switch (form.game_platform.val()) {
            case 'Android':
            case 'iOS':
                context.drawImage(image.box, 625 - 190 / 1.79, 190 - 190 / 1.89, 190 / 2.21, 190 / 2.21);
                break;
            default:
                context.drawImage(image.box, 625 - iw, 0, iw, ih);
                break;
        }
...
form.game_image_size.change(function () {
    var val = parseInt(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).val());
    if (val < 1) {
        val = 1;
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).val(1);
    }
    form.banner.data('zoom', val);
});
__WEBPACK_IMPORTED_MODULE_0_jquery___default()('select, input', form.form).bind({
    change: redraw,
    keyup: redraw
});

Object(__WEBPACK_IMPORTED_MODULE_13__func_behaviors_zoom_js__["a" /* default */])(form.banner, parseInt(form.game_image_size.val()));
Object(__WEBPACK_IMPORTED_MODULE_12__func_behaviors_move_js__["a" /* default */])(form.banner);
form.banner.bind({
    'moved': redraw,
    'zoom': function zoom() {
...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()('[data-role="changeImage"]', form.form).change(function () {
    var obj = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this);
    Object(__WEBPACK_IMPORTED_MODULE_10__func_helpers_readImageFromField_js__["a" /* default */])(obj, obj.data('width'), obj.data('height')).catch(function (error) {
...
form.form.bind({
    submit: function submit(e) {
        ...
        __WEBPACK_IMPORTED_MODULE_4_downloadjs___default()(data, filename, "image/png");
    },
...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()('[data-role="changeImage"]', form.form).change();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__result_js__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__source_js__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__helpers_reactions_js__ = __webpack_require__(13);





/* harmony default export */ __webpack_exports__["a"] = (function (id, otherObjs) {
    var ret = {
        form: __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#' + id),
        source: Object(__WEBPACK_IMPORTED_MODULE_2__source_js__["a" /* default */])(id),
        result: Object(__WEBPACK_IMPORTED_MODULE_1__result_js__["a" /* default */])(id),
        reactions: new __WEBPACK_IMPORTED_MODULE_3__helpers_reactions_js__["a" /* default */]('#' + id)
    };
    if (otherObjs) {
...
/* harmony default export */ __webpack_exports__["a"] = (function (id) {
    return __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#' + id + ' [name=result]');
});;
...
/* harmony default export */ __webpack_exports__["a"] = (function (id) {
    return __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#' + id + ' [name=source], #' + id + ' [name="source[]"]');
});;
...
/* harmony default export */ __webpack_exports__["a"] = (function (owner) {
    var obj = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(owner);
    this.error = function (error) {
        ...
        switch (obj.data(prefix + 'Action')) {
            case 'alert':
                ...
                break;
            case 'show':
                __WEBPACK_IMPORTED_MODULE_0_jquery___default()(obj.data(prefix + 'Target')).show();
                break;
        }
    };
});;
...
/* unused harmony default export */ var _unused_webpack_default_export = (function (parent_id) {
    var parent = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#' + parent_id);
    var progress = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('<div><div><span class="glyphicon glyphicon-refresh refresh-animate" data-role="animation"></span> <span data-role="msg">Apdorojama...</span></div></div>');
    progress.hide();
    progress.msg = function (msg) {
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('[data-role="msg"]', progress).html(msg);
    };
...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()('[data-role="canvas"]').each(function () {
    var canvas = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('<canvas></canvas>'),
        obj = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__draw_strokeText_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__draw_rgba_js__ = __webpack_require__(20);



/* harmony default export */ __webpack_exports__["a"] = (function (context, text, x, y, lineWidth, red, green, blue) {
    for (var i = lineWidth; i > 0; i--) {
        Object(__WEBPACK_IMPORTED_MODULE_0__draw_strokeText_js__["a" /* default */])(context, text, x, y, i, Object(__WEBPACK_IMPORTED_MODULE_1__draw_rgba_js__["a" /* default */])(red, green, blue, 1.1 - 1 / lineWidth * i));
    }
});;
...
"use strict";
/* harmony default export */ __webpack_exports__["a"] = (function (red, green, blue, alpha) {
...
"use strict";
/* harmony default export */ __webpack_exports__["a"] = (function (context, width, height, stepSize) {
    var grey = false;
    for (var x = 0; x < width; x += stepSize) {
        for (var y = 0; y < height; y += stepSize) {
            if (!(grey = !grey)) continue;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_when__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_when___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_when__);



/* harmony default export */ __webpack_exports__["a"] = (function (field, minWidth, minHeight) {
    field = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(field);
    return __WEBPACK_IMPORTED_MODULE_1_when___default.a.promise(function (resolve, reject, notify) {
        if (typeof field.get(0).files == 'undefined') {
            reject('old-browser');
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()(field).val('');
        } else {
...
!(__WEBPACK_AMD_DEFINE_RESULT__ = (function (require) {
	...
	var timed = __webpack_require__(24);
	...
	var TimeoutError = __webpack_require__(5);
...
"use strict";
/* harmony default export */ __webpack_exports__["a"] = (function (canvas, enabled) {
...
/* harmony default export */ __webpack_exports__["a"] = (function (obj) {
    obj = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(obj);
    obj.data({
        x: 0,
        y: 0
    });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jquery_mousewheel__ = __webpack_require__(41);
...
/* harmony default export */ __webpack_exports__["a"] = (function (obj, zoomLvl) {
    obj = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(obj);
...
"use strict";
/* harmony default export */ __webpack_exports__["a"] = (function (context, x1, y1, x2, y2, color1, color2) {
